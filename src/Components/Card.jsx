...
function Card (props){
  ...
  return (
    <div className="text-slate-300 " id='INFO'>
     
    <div className={` ${bg} flex-col items-center  rounded-2xl p-3 m-2 shadow-2xl `}>
    ...
    <div className='flex flex-wrap  justify-center  ' id='INFO2'>  
         <p className={`${bg} rounded-2xl p-3 m-2 flex flex-col gap-2 justify-center items-center text-2x shadow-2xl`} >
         ...
         <p className={`${bg} rounded-2xl p-3 m-2 flex flex-col gap-2 justify-center items-center shadow-2xl`}>
    ...
    <div className={`${bg} rounded-2xl p-2 m-2 flex flex-rov gap-4 justify-center shadow-2xl`}> 
